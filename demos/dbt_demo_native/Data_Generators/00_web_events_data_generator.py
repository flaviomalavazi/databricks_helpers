...
df_sessions = (
    ...
    .selectExpr("*",
                ...
                CASE
                    ...
                    WHEN page_url_path = "/" and utm_source = 'google' THEN (base_progression_probability * 0.55)
                    WHEN page_url_path = "/" and utm_source in ('facebook', 'instagram') THEN (base_progression_probability * 0.47)
                    WHEN page_url_path = "/" and utm_source = 'bing' THEN (base_progression_probability * 0.49)
                    ...
                    WHEN page_url_path = "products/product_a/" and utm_source = 'google' THEN (base_progression_probability * 0.65)
                    WHEN page_url_path = "products/product_a/" and utm_source in ('facebook', 'instagram') THEN (base_progression_probability * 0.5)
                    WHEN page_url_path = "products/product_a/" and utm_source = 'bing' THEN (base_progression_probability * 0.6)
                    WHEN page_url_path = "products/product_a/" and utm_source = 'mailchimp' THEN (base_progression_probability * 0.5)
                    WHEN page_url_path = "products/product_b/" and utm_source = 'organic' THEN (base_progression_probability * 0.75)
                    WHEN page_url_path = "products/product_b/" and utm_source = 'google' THEN (base_progression_probability * 0.6)
                    WHEN page_url_path = "products/product_b/" and utm_source in ('facebook', 'instagram') THEN (base_progression_probability * 0.7)
                    WHEN page_url_path = "products/product_b/" and utm_source = 'bing' THEN (base_progression_probability * 0.7)
                    WHEN page_url_path = "products/product_b/" and utm_source = 'mailchimp' THEN (base_progression_probability * 0.65)
                    WHEN page_url_path = "marketplace/" and utm_source = 'organic' THEN (base_progression_probability * 0.6)
                    WHEN page_url_path = "marketplace/" and utm_source = 'google' THEN (base_progression_probability * 0.7)
                    WHEN page_url_path = "marketplace/" and utm_source in ('facebook', 'instagram') THEN (base_progression_probability * 0.5)
                    WHEN page_url_path = "marketplace/" and utm_source = 'bing' THEN (base_progression_probability * 0.55)
...
print(f"Writing to Unity Catalog Delta table {target_table}...\t\t{datetime.now()}")
(
    df_sessions.write
        .format("delta")
        .mode(write_mode)
